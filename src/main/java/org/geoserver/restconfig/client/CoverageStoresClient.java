...
import org.geoserver.restconfig.api.v1.client.CoveragestoresApi;
import org.geoserver.restconfig.api.v1.model.CoverageStoreInfoWrapper;
import org.geoserver.restconfig.api.v1.model.CoverageStoreListWrapper;
import org.geoserver.restconfig.api.v1.model.CoverageStoreResponse;
import org.geoserver.restconfig.api.v1.model.CoverageStoreResponseWrapper;
import org.geoserver.restconfig.api.v1.model.CoverageStoresResponse;
import org.geoserver.restconfig.api.v1.model.PurgeOption;
...
public class CoverageStoresClient {
	...
	public CoverageStoreResponse create(@NonNull String workspace, @NonNull String name, String description,
			@NonNull CoverageStoreInfo.TypeEnum type, @NonNull String url) {
	...
	public CoverageStoreResponse create(@NonNull CoverageStoreInfo info) {
		...
		return this.findByWorkspaceAndName(workspace, info.getName()).orElseThrow(
				() -> new IllegalStateException("CoverageStore not found after being created: " + info.getName()));
	}

	public CoverageStoreResponse update(@NonNull String oldWorkspace, @NonNull String oldName,
		...
		return this.findByWorkspaceAndName(info.getWorkspace().getName(), info.getName()).orElseThrow(
				() -> new IllegalStateException("CoverageStoreInfo not found after being updated: " + info.getName()));
	}
	...
	public List<Link> findByWorkspace(@NonNull String workspace) {
		CoverageStoresResponse wrapper = this.client.collectionCall(() -> this.api().getCoverageStores(workspace),
				() -> new CoverageStoresResponse().coverageStores(new CoverageStoreListWrapper()));
	...
	public Optional<CoverageStoreResponse> findByWorkspaceAndName(@NonNull String workspaceName,
