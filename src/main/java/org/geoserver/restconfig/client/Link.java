...
/**
 * Value class to unify the mismatch in the geoserver REST API regarding mixed
 * usage of "href" and "link" attributes when returning a list of
 * {@link NamedLink named links}
 */
