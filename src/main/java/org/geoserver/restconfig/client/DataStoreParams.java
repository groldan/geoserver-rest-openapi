...
public class DataStoreParams {
	...
	public static Optional<ConnectionParameterEntry> find(@NonNull String name,
			@NonNull ConnectionParameters responseParams) {
		List<ConnectionParameterEntry> entry = responseParams.getEntry() == null ? Collections.emptyList()
