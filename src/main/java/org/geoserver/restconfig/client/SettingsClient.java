...
import org.geoserver.restconfig.api.v1.client.SettingsApi;
import org.geoserver.restconfig.api.v1.model.ContactInfoWrapper;
import org.geoserver.restconfig.api.v1.model.GeoServerInfoWrapper;
import org.geoserver.restconfig.api.v1.model.SettingsInfoWrapper;
import org.geoserver.restconfig.model.config.ContactInfo;
import org.geoserver.restconfig.model.config.GeoServerInfo;
import org.geoserver.restconfig.model.config.SettingsInfo;
...
public class SettingsClient {
	...
	/**
	 * Create workspace-specific settings Create new workspace-specific settings on
	 * the server.
	 * 
	 * @param workspace The workspace name (required)
	 * @param settings  The workspace-specific settings information to upload.
	 *                  (required)
	 */
	...
	/**
	 * Get the global contact information Displays a list of all global contact
	 * settings on the server. This is a subset of what is available at the
	 * /settings endpoint.
	 */
	...
	/**
	 * Update workspace-specific settings Updates workspace-specific settings on the
	 * server.
	 * 
	 * @param workspace The workspace name (required)
	 * @param settings  The workspace-specific settings information to upload.
