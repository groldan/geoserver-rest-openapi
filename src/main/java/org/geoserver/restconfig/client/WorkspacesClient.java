...
import org.geoserver.restconfig.api.v1.client.WorkspacesApi;
import org.geoserver.restconfig.api.v1.model.NamedLink;
import org.geoserver.restconfig.api.v1.model.WorkspaceResponseWrapper;
import org.geoserver.restconfig.api.v1.model.WorkspaceSummary;
import org.geoserver.restconfig.api.v1.model.WorkspaceWrapper;
import org.geoserver.restconfig.api.v1.model.WorkspacesResponse;
...
public class WorkspacesClient {
	...
	public WorkspaceInfo create(@NonNull WorkspaceInfo ws) {
		...
		WorkspaceInfo created = getAsInfo(ws.getName()).orElseThrow(
				() -> new NoSuchElementException("Workspace create endpoint didn't fail but workspace does not exist"));
