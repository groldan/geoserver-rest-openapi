...
import org.geoserver.restconfig.api.client.internal.ApiClient.Api;
import org.geoserver.restconfig.api.client.internal.auth.HttpBasicAuth;
import org.geoserver.restconfig.api.v1.client.ManifestsApi;
import org.geoserver.restconfig.api.v1.model.ComponentVersion;
import org.geoserver.restconfig.api.v1.model.VersionResponse;
 ...
 * </pre>
 * 
 * Note: all API calls that receive a server side error throw
...
public class GeoServerClient {
	...
	public GeoServerClient(@NonNull String restApiEntryPoint) {
		...
		Decoder decoder = new Decoder() {
			...
			public Object decode(Response response, Type type) throws IOException, DecodeException, FeignException {
				...
				String mime = contentType == null || contentType.isEmpty() ? null : contentType.iterator().next();
	...
	/**
	 * Utility method to clone a model object to overcome the issue that
	 * openapi-codegen generated models don't provide a copy constructor
	 */
	...
	/**
	 * When an API call results in an empty list, GeoServer returns @code{ "" }
	 * instead of @{code []}; this method makes the call and captures the JSON
	 * parsing error, defaulting to the value given by {@code defaultValue}.
	 * 
	 * @param <T>
	 * @param call
	 * @param defaultValue
