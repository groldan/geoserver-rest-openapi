...
import org.geoserver.restconfig.api.v1.model.DoubleArrayResponse;
import org.geoserver.restconfig.api.v1.model.NamedLink;
import org.geoserver.restconfig.api.v1.model.NumberRangeResponse;
import org.geoserver.restconfig.api.v1.model.ResourceResponseKeywords;
import org.geoserver.restconfig.api.v1.model.StringArrayResponse;
import org.geoserver.restconfig.model.catalog.KeywordInfo;
...
public interface ResourceResponseMapper {
	...
	public default List<KeywordInfo> map(ResourceResponseKeywords r) {
		return r == null || r.getString() == null ? null
