...
public interface CoverageResponseMapper extends ResourceResponseMapper {
	...
	@Mapping(target = "nativeCoverageName", source = "nativeCoverageName", //
			defaultExpression = "java(source.getParameters() == null? null : (String)source.getParameters().get(\"nativeCoverageName\"))")
