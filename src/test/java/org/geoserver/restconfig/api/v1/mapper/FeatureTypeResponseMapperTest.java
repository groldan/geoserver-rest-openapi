...
public class FeatureTypeResponseMapperTest extends SerializationTest {
	...
	public @Test void testMapFeatureTypeResponseToFeatureTypeInfo() throws IOException {
		...
		final FeatureTypeInfo expected = super.decode("FeatureTypeInfo.json", FeatureTypeInfo.class,
				FeatureTypeInfo.class);

		final FeatureTypeResponseWrapper responseWrapper = super.decode("FeatureTypeResponse.json",
				FeatureTypeInfo.class, FeatureTypeResponseWrapper.class);
