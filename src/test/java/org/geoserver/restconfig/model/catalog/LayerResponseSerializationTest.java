...
import org.geoserver.restconfig.api.v1.model.LayerResponse;
import org.geoserver.restconfig.api.v1.model.LayerStyles;
...
public class LayerResponseSerializationTest extends SerializationTest {
	...
	public @Test void testLayerResponseCoverage() throws IOException {
		LayerResponse lrw = decodeResource("LayerResponse_Coverage.json", LayerResponse.class);
		assertNotNull(lrw);
		...
		assertEquals("http://localhost:8080/geoserver/rest/styles/raster.json", response.getDefaultStyle().getHref());
	...
	public @Test void testLayerResponseFeatureType() throws IOException {
		LayerResponse lrw = decodeResource("LayerResponse_FeatureType.json", LayerResponse.class);
		assertNotNull(lrw);
		...
		assertEquals("http://localhost:8080/geoserver/rest/styles/simple_streams.json",
		...
		assertEquals("http://localhost:8080/geoserver/rest/workspaces/sf/datastores/sf/featuretypes/streams.json",
				response.getResource().getHref());
