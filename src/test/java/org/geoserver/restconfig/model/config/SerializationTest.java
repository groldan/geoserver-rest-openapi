...
public class SerializationTest {
	...
	private static final String WMS_INFO = SERVICE_INFO.replace("${serviceInfo}", //
	...
	private static final String WFS_INFO = SERVICE_INFO.replace("${serviceInfo}", //
			"\"gml\":{\"entry\":["//
	...
	private void assertGmlInfo(GmlInfo entry, String version, SrsNameStyle srsNameStyle,
			boolean overrideGMLAttributes) {
		GmlInfo expected;
		expected = new GmlInfo().version(version)
