...
import org.geoserver.restconfig.model.catalog.Version;
...
public class StylesClientMapBoxIT {
	...
	public @Test void getStyleBodySLD_1_0() throws IOException {
		...
		assertThat(stylesClient.getBody("line", StyleFormat.SLD_1_0_0),
	...
	public @Test void createStyleMapBoxOneLayer() throws IOException {
		...
		Version version = styleInfo.getFormatVersion() == null ? styleInfo.getLanguageVersion()
	...
	/**
	 * GeoServer can't handle styles with multiple layers and no source-layer
	 * property on each
	 * 
	 * @throws IOException
	 */
	...
	private String loadResource(String name) throws IOException {
		try (InputStream in = getClass().getResourceAsStream(name)) {
			...
			String content = new BufferedReader(new InputStreamReader(in, UTF_8)).lines()
